...
public class AWTCounter extends Frame implements ActionListener {
   ...
   public AWTCounter () {
      ...
      lblCount = new Label("choose location");  // construct the Label component
      ...
      setTitle("Tic-Tac-Toe");  // "super" Frame sets its title
      setSize(300, 300);        // "super" Frame sets its initial window size
